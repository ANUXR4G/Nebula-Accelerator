    ...
    <div className="font-sans text-black">
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-black mb-6 flex">About <span className="text-red-500">TEDx</span></h2>
          ...
          <div className="mt-6">
            <p className="text-3xl font-bold text-black flex">
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-black mb-6 flex">About <span className="text-red-500">TEDx Bharat</span></h2>
          <p className="text-xl leading-relaxed text-gray-800">
